                ...
                <div class="table-responsive">
                    <table class="table table-bordered table striped mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><h6 class="tex-left">{{$product->name}}</h6> </td>
                                <td><h6 class="tex-center">{{$product->barcode}}</h6> </td>
                                <td><h6 class="tex-center">{{$product->category}}</h6> </td>
                                <td><h6 class="tex-center">{{$product->price}}</h6> </td>
                                <td><h6 class="tex-center">{{$product->stock}}</h6> </td>
                                <td><h6 class="tex-center">{{$product->alerts}}</h6> </td>
